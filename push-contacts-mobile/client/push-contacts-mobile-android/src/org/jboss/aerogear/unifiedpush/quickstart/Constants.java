...
public interface Constants {
    ...
    /**
     *  This is the base url for the push-contacts-mobile-picketlink-secured application.
     *
     *  In the case of an Android VM the host machine's address would be:
     *  String BASE_URL = "http://10.0.2.2:8080/jboss-push-contacts-mobile-picketlink-secured";
     */
    String BASE_URL = "";
