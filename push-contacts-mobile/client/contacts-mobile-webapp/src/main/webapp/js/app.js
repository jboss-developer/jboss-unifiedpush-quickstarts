...
//To use the push-contacts-mobile-picketlink-secured REST API:
CONTACTS.app.serverUrl = window.location.protocol + "//" + window.location.host + "/jboss-push-contacts-mobile-picketlink-secured";
